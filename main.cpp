...
private:
    ...
    void createSyncObjects() {
        ...
        if(VK_SUCCESS != vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphore) || VK_SUCCESS != vkCreateSemaphore(device, &semaphoreInfo, nullptr, &renderFinishedSemaphore) || VK_SUCCESS != vkCreateFence(device, &fenceInfo, nullptr, &inFlightFence)) {
